...
public class Indextrabajador {
    ...
    public static void datosdeinstalacion() {
        ...
        trabajadores.add(t1);
        Trabajador t2 = new Trabajador(4000, "Sistemas", "Desarrollador", 15, "Pedro", "22222222");
        trabajadores.add(t2);
        Trabajador t3 = new Trabajador(7000, "Sistemas", "Arquitecto de Software", 16, "Manuel", "33322233");
        trabajadores.add(t3);
        Trabajador t4 = new Trabajador(4500, "Sistemas", "Analista", 7, "Maria", "99999888");
        trabajadores.add(t4);
        Trabajador t5 = new Trabajador(2200, "Ventas", "Cajero", 12, "Andres", "555121555");
        trabajadores.add(t5);
    }
